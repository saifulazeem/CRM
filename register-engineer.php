                        ...
                        <div class="navigation">
                            <ul>
                               ...
                               <li><a href="customer-list.php">Manage Customers</a></li>
                                <hr class="new2">
                                <li><a style="background-color: #2d2d2d;" href="register-engineer.php">Register Engineers</a></li>
                                <hr class="new2">
...
<!--                     <div class="row" style="text-align: center;">
            ...
            <div class='main col-lg-9 col-md-9 col-sm-12' >
                <h1 style="color: #4d4d4d; padding-top: 30px; padding-left: 20px;">Register Engineers</h1>
                <br>
                <br>
                <br>
                <form method="post">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-12" >
                                <input class="form-control" type="text" name="engr_alt_mobile" placeholder="Alt Mobile" >
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12" >
                                <input class="form-control" type="email" name="email_address" placeholder="Username*" required>
                            </div>

					...
					<table class="table table-striped  table-hover table-condensed" style="text-align: center;">
	                    ...
	                    <tbody>
	                        <tr>
	                            ...
	                            <td style="border-top: hidden;">CP1078</td>
	                            <td style="border-top: hidden;">Saif Azeem</td>
	                            <td style="border-top: hidden;">Pending</td>
	                            <td style="border-top: hidden;">00966500015</td>
	                            <!-- <td>1</td> -->
	                            <td style="border-top: hidden;"><a href="add_technician.php">Add</a></td>
	                           ...
	                           <tr>
	                            ...
	                            <td style="border-top: hidden;">00966500015</td>
	                            <!-- <td>1</td> -->
	                            <td style="border-top: hidden;"><a href="#">Add</a></td>
	                            <!-- <td><a href="https://www.appsvista.com/versions/antenne-bayern/download-4-9-1-912"><i class="fas fa-download"></i></a></td> -->
	                        </tr>
	                          <tr>
	                            <!-- <td>1</td> -->
